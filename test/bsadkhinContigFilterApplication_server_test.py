...
from bsadkhinContigFilterApplication.bsadkhinContigFilterApplicationImpl import bsadkhinContigFilterApplication
from bsadkhinContigFilterApplication.bsadkhinContigFilterApplicationServer import MethodContext
from bsadkhinContigFilterApplication.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class bsadkhinContigFilterApplicationTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('bsadkhinContigFilterApplication'):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'bsadkhinContigFilterApplication',
        ...
        cls.serviceImpl = bsadkhinContigFilterApplication(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_bsadkhinContigFilterApplication_" + str(suffix)
